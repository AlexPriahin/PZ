...
namespace Web_Service.Controllers
{
    ...
    {
        private readonly TransportNodesdbMainContext db;
        private string datanumber = "1047",
                       api_key = "772f096efd87beba336a008f5747b403";

        public DataController(TransportNodesdbMainContext context)
        {
            db = context;
        }
        ...
        public async Task<IActionResult> Create() 
        {
            try
            {
                ...
                var Deser_Obj = JDeserializer<List<TransportNode>>.Deser(data);

                db.TransportNodes.RemoveRange(db.TransportNodes);
        ...
        {
            int current_count = await db.TransportNodes.CountAsync(), count = 0;
        ...
        public async Task<IActionResult> Export()
        {
            try
            {
                ...
                {
                    sw.WriteLine(JWriter<List<TransportNodeInfo>>.Write(await db.TransportNodes.ToListAsync()));
                }
            }
            catch (Exception ex)
            {
